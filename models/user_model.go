...
type User struct {
	...
	FirstName       string        `bson:"first_name" json:"first_name" validate:"required,min=5,max=100"`
	LastName        string        `bson:"last_name" json:"last_name" validate:"required,min=5,max=100"`
